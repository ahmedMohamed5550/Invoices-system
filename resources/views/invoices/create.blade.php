                    ...
                    <form action="{{route('invoices.store')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" id="dueDate" name="Due_date" placeholder="YYYY-MM-DD"
                                type="text" required>
                            </div>
...
@section('js')
    ...
    {{-- <script>
        // validation to invoiceDate to disable date now
        document.addEventListener('DOMContentLoaded', function() {
            ...
            invoiceDate.value = "{{ date('Y-m-d') }}";

            // Disable the input field using JavaScript
            invoiceDate.disabled = true;

            form.addEventListener('submit', function(event) {
                invoiceDate.disabled = false;
            });
        });
