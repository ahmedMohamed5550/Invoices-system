...
@section('content')
        ...
        @if (session()->has('retreive'))
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>{{ session()->get('retreive') }}</strong>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
                                        ...
                                        <tbody>
                                            @foreach ($invoices as $invoice)
                                                <tr>
                                                    ...
                                                    <td>{{ $invoice->note }}</td>
                                                    <td>
                                                        <a class="btn ripple btn-primary btn-sm" href="{{ route('invoices.retreive', ['id' => $invoice->id]) }}">استرجاع الفاتورة</a>
                                                    </td>
