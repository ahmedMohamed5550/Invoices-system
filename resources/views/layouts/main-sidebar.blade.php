			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/brand/User Avatar Vector.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/index') }}">قائمة الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/showAllInvoicesPaid') }}">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/showAllInvoicesPartialyPaid') }}">الفواتير المفوعه جزئيا</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/showAllInvoicesUnPaid') }}">الفواتير الغير مدفوعه</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/archeive') }}"> ارشيف الفواتير</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='reports/invoices') }}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='reports/customers') }}">تقارير العملاء</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='users/index') }}">قائمة المستخدمين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='sections/index') }}">الاقسام</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='products/index') }}">المنتجات</a></li>
