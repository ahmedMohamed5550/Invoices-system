					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                                    ...
                                    <div id="unreadNotifications">
                                        @foreach (auth()->user()->unreadNotifications as $notification)
                                            <div class="main-notification-list Notification-scroll">
                                                ...
                                                <div class="mr-3">
                                                    <h5 class="notification-label mb-1">{{ $notification->data['invoice_number'] }} /
                                                        {{ $notification->data['section_name'] }}
                                                    </h5>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/brand/User Avatar Vector.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/brand/User Avatar Vector.jpg')}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{Auth::user()->name}}</h6><span>{{ substr(Auth::user()->email, 0, 20) }}</span>
											</div>
										</div>
									</div>
