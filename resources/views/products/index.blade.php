                                    ...
                                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                                        ...
                                        <tbody>
                                            @foreach($products as $product)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td> <!-- This will display 1, 2, 3, etc. -->                                                    <td>{{ $product->product_name }}</td>
                                                    <td>{{ $product->section->section_name ?? 'No Section' }}</td>
                                                                ...
                                                                <div class="modal-content modal-content-demo">
                                                                    ...
                                                                    <form action="{{route('products.destroy')}}" method="post">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input class="form-control" name="product_name" id="product_name" value="{{$product->product_name ?? '' }}" type="text" readonly>
                                                                        </div>
                                                                        <div class="modal-footer">
                                           ...
                                           <div class="modal-content">
                                               ...
                                               <div class="modal-body">
                                                ...
                                                <form action="{{route('products.update')}}" method="post" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" name="id" id="id" value="{{ $product->id ?? ''}}">
                                                        <label for="section_id" class="col-form-label">اختر القسم:</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="description" id="description" value="{{ $product->description ?? ''}}" type="text" required>
                                                    </div>
                                                    <div class="modal-footer">
