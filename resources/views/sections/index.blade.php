                                    ...
                                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                                        ...
                                        <tbody>
                                            @foreach ($sections as $section)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td> <!-- This will display 1, 2, 3, etc. -->
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{route('sections.store')}}">
                                        @csrf
                                           ...
                                           <input id="section_name" type="text" class="form-control @error('section_name') is-invalid @enderror" name="section_name" value="{{ old('section_name') }}" required autocomplete="section_name" autofocus>
                                            @error('section_name')
                                                   ...
                                                   <form action="{{route('sections.update')}}" method="post" autocomplete="off">
                                                    ...
                                                    @csrf
                                                       ...
                                                       <div class="form-group">
                                                           ...
                                                           <input class="form-control" name="description" id="description" value="{{$section->description ?? '' }}" type="text">
                                                       </div>
                                               </div>
                                               <div class="modal-footer">
